const events = [
    {
		...
		No existe un criterio unánime en cuanto a los orígenes de los primeros asentamientos humanos en esta zona del sur de la provincia de Córdoba. Según estudios efectuados por los jesuítas, los sobrevivientes de los querandíes de la época hispánica, después Ilamados Pampas, que en voz quechua significa Llanura, emigraron al oeste estableciéndose en lo que hoy son las provincias de La Pampa, Río Negro y el sur de Córdoba. 

    Vivían libremente en esa llanura que les proveía todo lo necesario. Pero apareció el hombre blanco y todo fue distinto. Algunos murieron contagiados por la viruela, la fiebre amarilla y la sífilis que portaba el conquistador; otros fueron sometidos a realizar labores en las primeras posesiones cristianas, pero no todos se adaptaron a un nuevo sistema al que no estaban preparados, donde les tocó la peor parte; no  faltaron grupos indígenas que se integraran al blanco, dando origen a los mestizos. 

    La mayoría de los Pampas rechazó el modus vivendi del conquistador, distinto al de sus antepasados y, mostrando su desacuerdo, se internó en su hábitat natural: el desierto. Su organización política no constituía una nación unificada, dirigida por un gobierno central. De cualquier manera hay antecedentes de una Confederación Indígena, inspirada por el Cacique Pampa Culfucurá e integrada por los Pampas, Ranqueles, Araucanos, Manzaneros y Tehuelches. De esa manera se pretendía un frente común para protegerse de la invasión del blanco, permanente violador de los Tratados de Paz que él mismo imponía y jamás cumplía.

    Los Pampas eran pueblos nómades y formaban tribus independientes entre sí, con caciques propios, aglutinados bajo una única autoridad cuando las circunstancias lo imponían. Para ello elegían al curaca, una especie de cacique mayor, seleccionado entre los jefes de mayor prestigio y condiciones de mando de las tribus reunidas.
    ...
    El principal comercio de trueque lo efectuaban desde 1670 con esos aliados circunstanciales que fueron los Aucaes, que eran nómades araucanizados que provenían de Chile. Esta alianza duró hasta comienzos del siglo XVIII, interrumpida por una sangrienta lucha fratricida que culminó con la derrota de los Pampas, que sólo atinaron a buscar refugio en las entonces incipientes poblaciones cristianas donde se fueron asimilando poco a poco. 

    De este fenómeno de araucanización de la pampa nacieron los Ranqueles, conocidos también como Ranquelches o Ranculches, que en voz araucana significa gente de los pajonales. Podríamos decir que los Ranqueles surgieron de la confluencia de numerosas tribus errantes, ocupando el sur de nuestra provincia y de Santa Fe y el oeste de Buenos Aires.  

    La definitiva araucanización de los Ranqueles comenzó en 1817, cuando Yanquetruz, inteligente cacique araucano recién llegado de Chile, fue declarado líder en reemplazo del desaparecido Cacique Calelian. Yanquetruz demostró tener capacidad para organizar militarmente alicaídas tribus, inyectándoles un espíritu poderosamente combativo. Luego de su muerte, en 1835, una legión de caciques disputaron la herencia del gobierno de su pueblo, pero al final, dispersas y divididas, generalmente por obra de los blancos, solo pudieron resistir hasta 1878, cuando fueron abatidos por las fuerzas nacionales, poseedoras de dos armas poderosísimas: la Remington y el Telégrafo. De esta manera se cumplía el plan que nació con Martín Rodríguez y que consistía en una guerra permanente, hasta el exterminio total del indígena. 
    ...
    Lucio Mansilla, en su "Excursión a los Indios Ranqueles", comenta, entre otras cosas, que jamás observó caciques que abusaran de su poder, incluso, cualquiera de sus subalternos tenía derecho a oponerse a la arbitrariedad de su jefe. No había autoridad jurídica ni policial y las cuestiones eran resueltas exclusivamente entre los interesados. El indio no toleraba el engaño ni la mentira, la repartija de sus botines se realizaba con igualdad y sin malicia. La tierra, los toldos y la caballada, al igual que el viento, las lluvias y el sol, eran de propiedad común. 

    Todos los historiadores coinciden en que entre los indígenas no existía la prostitución. Las mujeres eran sumamente laboriosas y no descuidaban su coquetería. Al casarse servían fielmente a su compañero, casi con sumisión total. En tanto las solteras, como las viudas, tenían plena libertad con su voluntad y con su cuerpo, sin que nadie tuviese el derecho de objetarles su conducta. 
...

    {
		...
		El gaucho, a similitud del indígena, vivía amando su libertad, ajeno al proyecto de país organizado que germinaba en la ciudad porteña. Para él no existía otra patria que aquella que sentía vibrar bajo sus pies, o bajo los cascos de su inseparable compañero: el caballo. 

    Perteneció a un mundo que tampoco fue asimilado por la "civilización". Este enfrentamiento arrastró al país a las guerras civiles y a la desintegración social. Se luchó en nombre de la libertad, del país, de la Constitución; pero en realidad, en estas guerras sólo valían los intereses mezquinos: la tierra como propiedad privada y no como pedazos de patria. 

    Antes de continuar, conviene hacer notar un factor de intolerancia que llevó a la disgregación del país. La organización social que se edificaba en la gran ciudad tenía sus ojos puestos en las ideas civilizadoras de Europa, negando o ignorando el conflicto que, subterráneamente, comenzaba germinar con el no reconocimiento de dos mundos reales: el indígena y el criollo.
    ...
    De esa manera el gaucho quedó apretujado entre el desierto, habitado por el infiel, y la ciudad, que le iba limitando su espacio vital. Poco a poco se fue arenizando en la inmensidad de la pampa, identificado con el deambular tras el arreo, la tropa, la frontera o la montonera. Esta estructura de organización social y de trabajo empujó al hombre a transitar en soledad la  pampa, porque esa floreciente industria del ganado no era sedentaria, ya que cambiaba de lugar a medida que se iba consumiendo el pasto o cuando la sequía diezmaba la manada. Esta acentuación geográfica de un perfil de vida ganadera, quizás sea un argumento para comprender el repudio gauchesco a la población estable organizada. 

    Dadas las guerras civiles y las luchas de frontera, el gaucho, reclutado involuntariamente por las autoridades que él rechazaba, partió al desierto y la mujer, entonces, se vio obligada a acompañarlo. 

    El amor a la libertad y al caballo impulsaban la vida del gaucho. Y bajo el precario techo de paja de un rancho, quedó registrada la presencia criolla de quienes fueron los segundos habitantes de estos lares. 
    ...
    },
    {
        title: "Inmigrantes",
        date: "< 1893",
        content: `LOS INMIGRANTES - “HACER LA AMÉRICA” 
    
    Bajaron de los barcos. Venían a “Hacer la América” y volver a sus tierras de origen, pero la mayoría de estos inmigrantes se quedó, y no sólo hicieron la América sino que pasaron a ser parte de ella.
    ...
    UNA REALIDAD ESCRITA EN NÚMEROS 
    CENSO DE 1900
    ...
    El Gobierno de la provincia había observado que el tendido del ferrocarril andino no activó espontáneamente el proceso de colonización como se suponía. A fin de dinamizar esa necesidad de poblar la pampa, casi desértica, se dictó Ia Ley de Colonización, el 2 de agosto de 1886, concediendo una serie de ventajas a los propietarios de latifundios que iniciaran colonias. La ley establecía que debía considerarse despoblada toda colonia que luego de dos años de su fundación no tuviese, como mínimo, veinte familias por legua cuadrada. Constaba en ella que el perímetro de toda colonia debía estar determinado por calles de un ancho mínimo de diez metros y los lotes separados por calles vecinales. Para acogerse a esta Ley de Colonización entre otros requisitos, se debía presentar al Poder Ejecutivo de la provincia una solicitud donde se expresase el área, situación y nombre que tendría el centro proyectado, planos de la traza, divisiones de la colonia y del pueblo a fundarse. 
    
    Indudablemente esta ley provincial fue promotora de Ia fundación de numerosos pueblos del sur cordobés.
     
    El 21 de junio de 1893 el gerente del Banco Agrícola Comercial del Río de la Plata, Deodoro Roca, solicitó al Ministerio de Hacienda la aprobación necesaria para acogerse a los beneficios otorgados por la Ley de Colonización. La propuesta consistió en la fundación de dos colonias ubicadas en los campos conocidos en ese momento con el nombre de “Español Muerto" y "El Tambito”. Se dispuso que esas nuevas colonias se lIamasen "General Cabrera" y "La Agrícola" respectivamente. 
    
    El 30 de junio de 1893, el Gobernador de Córdoba, doctor Manuel Didimo Pizarro, aprobó los planos de ambas colonias.`,
    },
    {
        title: "Estafeta Postal - Correo",
        date: "1900",
        content: `Nace como Estafeta de Correo en 1900, funcionando en un vagón a la vera de la vía ferroviaria del Ferrocarril Central Argentino que además oficiaba de estación provisoria. Todo bajo la responsabilidad del único personal ferroviario.
    ...
    Eran tiempos en que el correo era el único medio de comunicación a distancia, incluso con la otra parte de los afectos que habían quedado en el viejo continente. Las cartas eran ordenadas en casilleros ya que por falta de carteros los destinatarios debían pasarla a recoger personalmente. 
    
    Años después, don Peretti se muda a la primera cuadra de la calle ancha (hoy bulevar San Martín) a una casa que históricamente tuvo el honor de haber sido en 1938, la sede del primer Gobierno Comunal de nuestro pueblo.
    
    En el 1932 se alquila un local aledaño a la Oficina de Teléfonos (hoy calle Intendente Frouté entre General Paz y Saavedra). Dado el crecimiento del pueblo en 1923, abandona su condición de Estafeta recategorizándose como Oficina Postal y meses después al instalarse el Telégrafo se habilita como Oficina Mixta bajo la jefatura de Leon Arce, auxiliar Juan B. Peretti y oficiando de cartero su hijo José.
    
    La sede propia fue inaugurada el 20 de junio de 1967, en un acto conjunto con la Oficina de Teléfonos. 
    
    Nuestro Correo también se vio afectado por la política de privatización de empresas estatales que se lleva a cabo durante la gestión de gobierno del Presidente Carlos Saúl Menem y su Ministro de Economía Domingo Cavallo. Debido a ello pasa a integrar el capital de la Corporación Macri bajo la nominación de Correo Argentino. A partir de entonces la filial General Deheza quedó a cargo de Gustavo Caraffa.`,
    },
    {
        title: `Estación Ferroviaria "General Deheza"`,
        date: "1905",
        content: `Nuestra Colonia "La Agrícola" no escapó a la necesidad de incorporarse a las reglas de mercado impuestas. Por ello, se hizo imprescindible contar con una estación ferroviaria que facilitase la carga de sus cosechas, eludiendo el contratiempo que significaba su traslado a través de caminos casi intransitables, en épocas de lluvias, a las estaciones más cercanas. 
    ...
    El 10 de diciembre de 1896 el Presidente de la Nación, doctor José Evaristo Uriburu, aprobó por decreto la autorización a la Dirección de Ferrocarriles Nacionales para librar al servicio público la estación provisoria que se denominaría "General Deheza". Con los años, nuestra localidad adoptaría la misma nominación.`,
        image: "assets/LineaGeneral/1905 - Estacion Ferrocarril.jpeg",
    },
    {
        title: "Teléfono",
        date: "1913",
        content: `Muy tempranamente, de la mano de la Compañía América Telefónica llegó la telefonía a General Deheza. Esta pequeña empresa, de propiedad del señor Heraldo Rescia de la localidad de Las Perdices, ofrecía el servicio limitado a ambas localidades, sumándose la de General Cabrera.

    En marzo de 1913 la oficina se instaló en el domicilio de don Juan María Frouté (hoy Intendente Frouté casi esquina Saavedra), quedando la atención de la misma a cargo de la señora Teresa Daviou de Frouté, precisamente la madre de nuestro primer jefe comunal.
    
    No se hubiese justificado entonces la confección de una guía, ya que en sus comienzos sólo veintiún aparatos telefónicos comprendía la lista de abonados al servicio en las tres localidades, de los cuales sólo cinco pertenecían a nuestro pueblo, a saber: 
    
    1 - Ángel Racca
    2 - Casa Cavalchini, Maino y Cia.
    3 - Dionisio Urquía
    4 - Destacamento de Policía
    5 - Juan Bergoglio
    ...
    En marzo de 1957 tras largas gestiones llevadas a cabo se dispuso la instalación del servicio de Telefonograma. 
    ...
    Años después surge la posibilidad de que nuestra Cooperativa Eléctrica conjuntamente con ENTEL acuerden un programa de financiación conjunta permitiendo instalar en General Deheza una central automática conectada al Sistema Nacional de Telediscado TELECOM.
    
    Gracias al tesón puesto en el proyecto, el día 30 de agosto de 1984 queda inaugurada la nueva Central Automática Telefónica con su sede en calle General Paz al lado de la Plazoleta del Centenario.
    
    En 1990, la administración Menem - Cavallo en cumplimiento de su programa de gobierno procede a la privatización de varias empresas estatales entre ellas ENTEL. Mediante la intervención gestora de la funcionaria ingeniera María Julia Alsogaray dos empresas extranjeras se convierten en propietarias de nuestro sistema de telecomunicaciones, Telecom y Telefónica Argentina.
    
    Finalmente, en octubre de 2002 una resolución de la Secretaría de Comunicaciones de la Nación otorga a la Cooperativa Eléctrica de General Deheza limitada, la licencia única de servicio de telecomunicaciones.`,
    },
    {
        title: "Usina de Luz y Fuerza Motriz",
        date: "1923",
        content: `Por un decreto del Gobierno provincial del día 21 de julio de 1923, la tradicional casa de comercio Cavalchini, Maino y Cia. S.R.L., queda autorizada para instalar una Usina Eléctrica en nuestra localidad.

    Velas, faroles y lámparas varias condicionaban el quehacer pueblerino cuando llegaba la noche. 

    Muchos aún la recuerdan con el cariñoso mote de "la vieja usina" en cuyo comienzo se ajustó a la potencia de un solo motor que proveía luz en el horario de 18 a 24 horas. Con el curso del tiempo, el servicio fue incrementado a un horario más generoso, gracias a la incorporación de dos nuevos motores. 

    Cuando circunstancias especiales como la atención de un parto, el fallecimiento de alguien o, por lo contrario, cuando una ocasión bailable lo exigía, la población gozaba de unas horitas extras de luz eléctrica.

    Los medidores de la luz de los aproximadamente doscientos usuarios se hallaban en el interior de la vivienda lo cual facilitaba un clima de familiaridad cada vez que el empleado de la usina visitaba la casa para medir el consumo. 

    La corriente continua, a diferencia de la alternada, poseía muchas desventajas, ya que a los usuarios que vivían más alejados de la usina la energía eléctrica le llegaba más debilitada, como así también se observaba una disminución notable cada vez que había función de cine, debido al consumo del proyector.

    Algunos aún recuerdan la clásica señal de las dos bajadas de luz antes de la medianoche, con que los operarios de la vieja usina advertían que en quince minutos se cortaría el suministro eléctrico. El desarrollo poblacional sumado a la incipiente actividad industrial, comenzaron a demandar un mayor consumo energético y ello obligó a buscar nuevas soluciones que la vieja usina de Cavalchini, Maino y Cia. S.R.L. ya no podía dar al estar sobrepasada su oferta de servicio.`,
    },
    {
        title: "Registro Civil",
        date: "1926",
        content: `Fue en mayo de 1924 cuando un decreto del Gobierno de la provincia aprueba el establecimiento de una oficina de Registro Civil en General Deheza.
    ...
    Como hecho anecdótico cabe recordar que el nacimiento de nuestro primer Intendente Municipal, don José Frouté, está registrado en Las Perdices. La primera pareja de enamorados documentada en el libro de "casamientos” fue la constituida por los jóvenes Jorge Armando y Amalia Garelis, ambos descendientes de familias pioneras provenientes de ltalia, contrajeron enlace el mismo día de inauguración de esta oficina.`,
    },
    {
        title: "Juzgado de Paz",
        date: "1927",
        content: `Fue creado en 1927 de acuerdo a la Ley Nº 3726, en cuyo decreto también dejó establecida su jurisdicción. Correspondiendo al área entre los límites con el Departamento Tercero Arriba en el norte y oeste, al oeste con la jurisdicción del Juzgado de Bengolea y al sur en una imaginaria línea entre Deheza y Cabrera a cinco kilómetros de la Plaza San Martín.
    ...
    Al Juzgado de Paz además le corresponde asumir como autoridad local responsable, cada vez que se lleva a cabo el Acto Eleccionario.

    Actúa como Organismo Oficial Supervisor, bajo las directivas impartidas por la Junta Electoral Federal y el Supremo Tribunal de Justicia de la Provincia de Córdoba. En circunstancias en que los Comicios sólo pertenezcan al ámbito comunal, es la Junta Electoral Municipal la responsable de todo lo concerniente al Acto Eleccionario, ya sea la depuración de padrones, confección de las boletas, constitución y funcionamiento de las Mesas Electorales y otras.

    El carácter permanente de esta Junta quedó constituido mediante una Ordenanza Municipal durante la gestión del Intendente Reinaldo Lizio. Está conformada por tres miembros designados por el Juez Electoral Provincial.

    La presidencia corresponde a el/la juez/a titular del Juzgado de Paz local y sus dos vocales se designan entre los directivos de establecimientos educativos con mayor antigüedad de servicio.`,
    },
    {
    ...
    },
    {
        ...
        date: "1940",
        content: `La salud pública fue una de las preocupaciones que nuestro primer Intendente, don José Frouté, priorizó en su labor comunitaria. Por ello inmediatamente gestiona al Gobierno de la Nación un subsidio el cual, sumado a los fondos recaudados en los Festejos Patronales, le impulsa a la fundación de una Sala de Primeros Auxilios, cuya obra se concreta en 1940. Esta Sala, guardiana de la salud comunitaria, crece alcanzando el rango de Hospital. 
    ...
    Al poco tiempo se iniciaron las tareas de re funcionalidad consistente en: oficina para director, consultorio externo, archivo, remodelación de frente y amoblamiento, adecuándose a las nuevas necesidades. 
    ...
    Nació con el objetivo de impartir una preparación técnica que posibilitase una salida laboral. Por entonces "El Telar”, como familiarmente lo llamaban, funcionaba subsidiado íntegramente por la municipalidad.`,
        image: "/assets/LineaGeneral/1947 - Taller de Tejeduria Angel Racca.jpg",
    },
    {
        title: "Barrio Municipal",
        date: "1948",
        content: `El Barrio Municipal estaba ubicado a sólo una cuadra de la actual Plaza San Martín. Fue gestión del Intendente José Frouté en su intención de ser destinadas a personal policial. Fueron nada más que tres viviendas de las cuales ninguna se mantiene en pie.`,
        image: "/assets/LineaGeneral/1948 - Barrio Municipal.jpg",
    },
    {
        title: "Hogar de Ancianos",
        date: "1948",
        content: `En enero de 1948 el Poder Ejecutivo provincial autorizó al entonces Comisionado Municipal José Frouté a construir el edificio del Hogar de Ancianos, merced a un subsidio otorgado para tal fin. En todo momento esta institución dependió de la administración municipal, contando con la colaboración de fuerzas vivas y aportes voluntarios de la población.
		`,
    },
    {
...

    {
        ...
        date: "1988",
        content: `Ambos organismos tienen como actividad central ejercer el control sobre las operaciones de exportación e importación. El Resguardo Aduanero General Deheza es una institución dependiente de A.F.l.P. y desde esta localidad tiene facultades para atender una vasta región del sur cordobés, en operaciones que en su casi totalidad están relacionadas a exportaciones de maní, en menor escala otros cereales y sus derivados manufacturados (aceite, harinas, mayonesas, etc.). Las importaciones efectuadas son de menor escala y por lo general corresponden a bienes de capital.
    ...
    },
    {
        ...
        date: "1988",
        content: `A poco de asumir el Intendente Roberto Urquía, gestionó una filial local a fin de agilizar la relación entre los productores, la Junta y todos los eslabones de la productividad agrícola. Interviene agilizando las exportaciones de cereales y oleaginosas.

    Durante la gestión del Presidente Carlos Saúl Menem, este organismo nacional fue disuelto. Tiempo después las funciones que desempeñaba esta Junta se transfieren a otro organismo: SENASA.
    ...
    },
    {
        ...
        date: "1993",
        content: `Durante la gestión del Intendente Rodolfo Coda, se crea la Escuela Municipal de Deportes para que los niños de la localidad tuvieran otro lugar para la práctica deportiva-recreativa, ya que en ese momento sólo había una institución dedicada a la práctica del fútbol infantil.
    ...
    Después se construyó un playón de cemento gracias a un subsidio proveniente de la Secretaría de Deportes de la provincia de Córdoba. Cinco años después se incorporaba la disciplina de atletismo la cual, junto al fútbol infantil, permitió que ciento cuarenta niños y
    ...
    },
    {
        ...
        date: "2000",
        content: `Inicia su actividad al asumir el Contador Roberto Daniel Urquía como Senador Provincial, en representación del Departamento Juárez Celman, ejerciendo la Presidencia de la Comisión de Presupuesto de la Cámara de Senadores. Cabe acotar que la Reforma Constitucional de nuestra provincia modificó al Ente Legislativo que anteriormente constaba de dos Cámaras, la de Senadores y la de Diputados, fusionándose en un solo órgano Unicameral, pasando a denominar a sus miembros con el rango de Legisladores.
    ...
    - Centro de Formación y Evaluación Técnica (conjuntamente con la Asociación Empresarial General Deheza y el Instituto Técnico "Adrián P. Urquía").`,
    },
    {
        title: "Fundación Multiplicar",
        date: "2000",
        content: `Esta fundación, sin fines de lucro, fue creada el 2 de mayo del 2000 a fin de propiciar la generación, desarrollo y sostenimiento de actividades productivas responsables del crecimiento económico de la región.
    ...
    Una de las razones por la que se constituye la Fundación Multiplicar como Ente Supramunicipal es precisamente porque considera que el respaldo municipal a las iniciativas privadas, potencia las posibilidades locales de desarrollar estructuras de crecimiento sostenibles y más efectivas.`,
    },
    {
    ...
    {
        title: `Asociación Empresarial "General Deheza (A.E.G.D.)"`,
        date: "2004",
        content: `Partir de la inquietud por compartir las necesidades del sector y crear un equipo de trabajo basado en el apoyo mutuo, fueron los principios esgrimidos por un grupo de empresarios de la localidad para dar nacimiento a esta asociación que hoy los nuclea. 

    Sus primeros pasos fueron respaldados por sus pares de la experimentada Asociación de Empresarios de la Región Centro Argentina (A.E.R.C.A.) cuya sede se encuentra en la ciudad de Villa María. Forman parte de sus objetivos la defensa de los intereses de los empresarios del comercio, la industria, el agro y los servicios. Además fomentar el espíritu de asociación y organización y, de esta manera, alcanzar beneficios para los asociados.
    
    Entre sus tareas llevadas a cabo podemos citar:
    
    - Un convenio con la Universidad Empresarial Siglo XXI, para brindar en la localidad, carreras de grado, diplomáticas y tecnicaturas, a través de la modalidad presencial o a distancia.

    - Conjuntamente con la Fundación Multiplicar y el Instituto Técnico "Adrián P. Urquía", se ha implementado el Centro de Formación y Evaluación Técnica (CFET), a fin de brindar capacitaciones específicas demandadas por las empresas que necesitan mano de obra especializada. 

    - Asesoramiento profesional en los ámbitos contables, impositivos, jurídicos laborales, legales, administrativos, organizativos, de recursos humanos, protocolar, entre otros.`,
    },
    {
        title: "Aduana",
        date: "2009",
        content: `Su radicación en General Deheza obedece al impacto de su comercio exterior y como un centro logístico para generar un control transparente y la seguridad jurídica, acelerando procesos y gestiones y facilitando los trámites de quienes producen y quieren exportar, abriendo nuevos mercados a nivel mundial.

    Este logro nació como proyecto del contador Roberto Urquía quien, tras asumir como presidente de la Comisión de Presupuesto y Hacienda, el primer punto de la orden del día, fue darle la sanción definitiva al proyecto de ley aprobado por Diputados de la creación de la Aduana en nuestra localidad.
    
    Esta Aduana será la segunda en la provincia, en el corazón mismo de una región pujante donde anualmente se exportan desde aceites, mayonesa, maní, harina, carnes, maquinarias agrícolas, etcétera.`,
    },
];
