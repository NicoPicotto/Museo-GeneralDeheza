...
Fundada en 1931 en General Deheza, Córdoba, Gastaldi Hnos es pionera en el negocio del maní y también se destaca en la producción de harina para panaderías. La empresa exporta alrededor de 25.000 toneladas de maní a 50 países y vende harina de trigo a todo el centro y noroeste argentino. Con una capacidad de producción de 350 toneladas por día, Gastaldi Hnos se ha consolidado como un referente en la industria alimentaria, empleando a más de 200 personas y manteniendo altos estándares de calidad e inocuidad alimentaria.
`,
      assets: [
         "./assets/DiaIndustria/Gastaldi/Gastaldi_01.jpg",
         "./assets/DiaIndustria/Gastaldi/Gastaldi_02.jpg",
         "https://www.youtube.com/watch?v=MuBUSEXMG7o",
      ],
   },
   {
...
`,
   ...
   {
      title: "Frigorífico General Deheza",
      date: "1941",
      logo: "./assets/DiaIndustria/Frigorifico/logo.png",
      content: `Dada las características de la región, la industria cárnica tuvo pronto su lugar.  Frigorífico Frideza, se instaló en General Deheza generando fuente de trabajo, permitiendo desarrollar el comercio de productos porcinos y vacunos no sólo en la localidad sino en toda la región. Su calidad premium de carnes y embutidos es un sello diferencial que lo distingue.
`,
      assets: [
...
`,
   ...
   },
   {
      ...
      content: `Alberto Carlos Koltsch se recibió de tipógrafo en Córdoba en el año 1934, dando inicio a su carrera en el mundo del arte gráfico.

En su recorrido por la vida se encuentra con José Froute, visionario que siempre miraba el más allá, buscando progresar y ayudar a quien esté dispuesto a crecer. Fue quien lo anima a Alberto, a instalar el primer taller gráfico en la localidad de General Deheza, siendo pionero así de la industria de la imprenta. Taller que se volvió su pasión. Pasión que transmitió a su hijo, quien tuvo el gran desafío de continuar con el desarrollo de la imprenta ante la llegada de la tecnología. Reinventó cada puesto de trabajo para mantenerla viva. Fruto de ello, la imprenta en la informalidad fue reconocida como la imprenta del Chamaco. Con la llegada de una nueva etapa de la vida, Chamaco le pasa el legado a su yerno Mauricio Caisutti, y hoy sigue vigente en las manos de Antonio Yanucci.
`,
   ...
   },
   {
      ...
      content: `En el año 1951, en la esquina de las calles Santa Fe y Bv San Martín, nació “La Firmeza”. Héctor Bedolla, fundaba la carpintería que sentaría precedentes, por esos años, en la comunidad de General Deheza. Años más tarde, sería el mentor de la “tabla de planchar plegadiza” que registraría como propia y que llevó la marca registrada de “La Firmeza”.

Héctor “Pibin” era apasionado por lo que hacía, dedicaba horas al diseño de cada mueble que le solicitaban, buscaba estar a la altura de las exigencias de sus clientes, plasmando en papel aquello que ellos soñaban.

La carpintería se desarrollaba en pleno centro de la localidad, sobre calle Santa Fe, a cargo de Pibin y operarios que lo ayudaban en ésta labor. Con el tiempo llega la incorporación de su hijo Lucas, quien inspirado por su padre le da un giro a la fábrica. Anexó nueva tecnología que permitía hacer esos diseños de manera más rápida y realista, agilizando así los tiempos de presupuestación y fabricación, pero manteniendo las mismas líneas de perfección que caracterizó siempre a “La Firmeza”.

El propio crecimiento y la incorporación de nuevas máquinas, llevó a reestructurar los lugares de trabajo, poniendo en evidencia la necesidad de buscar un nuevo lugar que le permita seguir progresando. Así fue como hoy, ubicada en zona mixta de General Deheza, continúa su crecimiento dirigido por Lucas.
`,
      assets: [
   ...
   },
   {
      ...
      content: `Ya con sus 13 años en el campo, Luis, acompañaba a su familia en todos los trabajos. Con el tiempo comienza a trabajar en el pueblo junto a Belloni lavando valdes, y es ahí donde recibe su apodo con el cual se lo reconocería en la industria de la construcción: “Fletacho”.
...
Así fue como Fletacho fue creciendo, a la par de ingenieros, arquitectos, patrones con su clara convicción de diferenciarse por la calidad. Capitalizando cada experiencia,  llegando a ser un referente de la industria y formador de muchos albañiles que hoy trabajan en nuestra localidad.
`,
   },
   {
   ...
   },
   {
      ...
      content: `Allá por el año 1958, Don Elvio, siendo empleado de la ferretería de Cavalchini Maino, tiene la invitación y motivación de su hermano Aldo para crear una sociedad e instalar la primera fábrica de mosaicos denominada Aldo y Rubén Foglizzo. Aldo, quien era albañil en ese entonces, aportaba el capital y Elvio el trabajo. Así fue el comienzo de la fábrica, en un galpón asentado en barro, con el pensamiento de que si no andaba se podría destruir sin arriesgar demasiado.
      
      Pasaron los años y ese galpón se convirtió en “la fábrica de mosaicos”. Años que no fueron fáciles. El agente de despegue fue un tema que desde primer momento les fue difícil pulir, mucho dinero invertido y pocos resultados buenos. Luego, mucha producción y pocas ventas. Pero ellos tenían claro su objetivo y seguían apostando. Pusieron los pisos en el cementerio local, obra que les llevó muchos años, ya que ellos tenían una capacidad de producción diaria de 20 mts de mosaicos.
...
Tiempo después, Rubén regresaba del servicio militar. Aldo se retira de la sociedad dando lugar a que Rubén ingrese a la firma y le de su impronta, cambiando así la razón social a Elvio y Rubén Foglizzo. Él motivado por apoyar la actividad ganadera introduce los premoldeados de hormigón y más tarde, observando que la industrialización llegaba a la fabricación de mosaicos, comienza a incursionar en la industria de los Mármoles, creando la primer maquina de cortar marmol e incorporando dicho rubro a la industria.
Con el fallecimiento de Elvio, Rubén continúa la firma acompañado por su familia, denominando la misma Aguadas y Premoldeados Foglizzo, recordando los orígenes y las motivaciones que lo llevaron a ser parte.
`,
      assets: [
...
`,
   ...
   },
   {
      ...
      content: `Santiago empieza su carrera aeronáutica en el Aero Club Villa Dolores en el año 1955. Integrante de su comisión directiva como colaborador de la institución, se ve atraído por la posibilidad de iniciar la Carrera de Piloto, lo cual logra en el mismo año. Por aquellas épocas hacía taxi aéreo desde Villa Dolores a Córdoba, de un solo pasajero, dado el tamaño de la aeronave. Mezclando placer y trabajo, decide seguir con la carrera en Buenos Aires y en 1961 obtiene su Licencia de Piloto Comercial. Pudiendo decidir en aquellos años entre ser Piloto de Línea Aérea y Aeroaplicador, se lanza por su pasión al tipo de vuelo a hacer Aeroaplicaciones, recorriendo Buenos Aires, Santa Fe, Entre Ríos y Centro Sur de Córdoba realizando esta tarea. Años más tarde forma familia y decide radicarse en General Deheza, que era uno de los pueblos donde él trabajaba y desde allí podía apreciar la majestuosidad de las sierras grandes que lo remontaban a sus comienzos. De allí se desprende su primer nombre de fantasía "Aero Cerros", que a través de los años y con la incorporación de Aeronaves Específicas para la actividad fue cambiando hasta terminar en el nombre actual "Abrile Aviación Agrícola”, donde conserva su tradicional trabajo de Pulverización Aérea e incluye los trabajos de Dispersión de sólidos (siembra aérea, fertilizantes y cebo tóxico).
...
`,
   ...
   },
   {
      ...
      content: `Empresa familiar, que en 1967 abrió sus puertas por primera vez de la mano de su fundador  Pedro Ángel Larovere, destacándose siempre por  su compromiso con la calidad y el respeto al cliente. Desde sus inicios, Pedro estableció una filosofía empresarial basada en el cumplimiento de la palabra, un valor que ha perdurado a lo largo de las décadas y que sigue guiando a la empresa en la actualidad.

Su principal actividad fue la fabricación de ataúdes de fibra de vidrio, un producto que no solo refleja la innovación y la calidad, sino que también responde a las necesidades de un sector muy sensible.
...
Avanzaron de a poco, con mucho esfuerzo y con todo el apoyo de su familia. Entre ellos su señora, quien sin haber asistido al secundario, fue siempre la administradora contable de la época.

Así Héctor, fundador, visionario y emprendedor, comenzó armando aberturas para viviendas, panteones, rejas; apostando al desarrollo de la comunidad y de las empresas presentes. Incorporando áreas  de corte y plegado,  de pintura y terminación, tecnología de punta y así contribuir no sólo al desarrollo industrial sino también del sector agropecuario, siempre generando puestos de trabajo y demandando de la ayuda de su familia.
...
`,
   ...
   {
      title: "Bertero Construcciones",
      date: "1971",
      logo: "./assets/DiaIndustria/Bertero/logo.jpg",
      content: `La historia de la empresa familiar se remonta a la década de 1940, cuando el Sr. Carlos Bertero comenzó su carrera como albañil. Durante esos años, participó en importantes proyectos de construcción, algunos de ellos son, la alcohelera de San Nicolás en Buenos Aires, el Cerro Áspero, y diversas escuelas rurales en la provincia de San Luis.

A mediados de los años 60, su hijo, el Sr. Juan Carlos Bertero, decidió seguir los pasos de su padre y, con tan solo 12 o 13 años, se unió a la empresa familiar, comenzando así a colaborar en las actividades de construcción que ésta desarrollaba.

En la década de 1980, tras el fallecimiento de su padre, Juan Carlos asumió la dirección de la empresa en solitario. Durante este período, desarrolló un galpón que, con el tiempo, fue ampliando mediante la adquisición de nuevas maquinarias. Esta expansión le permitió incorporar el hormigón en los proyectos de la empresa, participando activamente en numerosas obras de la ciudad, en conjunto con la Municipalidad de General Deheza, como la pavimentación de calles. Además, la empresa comenzó a prestar servicios tanto a ciudadanos de las ciudades alrededor como a importantes compañías de la zona como AGD, Gastaldi, etc., fortaleciendo su presencia en el sector.

Entre los trabajos que la empresa ha realizado y continúa realizando hasta la fecha, se incluyen pavimentos, desmontes, movimientos de suelos, retiros de tierra y escombros, excavaciones, plateas, entoscados, nivelaciones, demoliciones, limpieza de terrenos, y construcción de pilotes, entre otros.

En el año 2010, la empresa trasladó sus operaciones a un galpón más amplio ubicado en el Parque Industrial de la ciudad, un entorno que alberga numerosas empresas exitosas. Desde entonces, ha continuado participando en proyectos de construcción, consolidando su reputación en el mercado.
...
Juan dejó de lado su profesión de Agrónomo, para abocarse de lleno a esta industria tan innovadora, que la veía como una buena oportunidad de negocios. Formó mano de obra y fruto de ello generó nuevos emprendimientos afines en la localidad.

Con el paso del tiempo la fábrica se trasladó a su actual ubicación sobre Ruta Nacional 158. Cuando Juan no pudo continuar con la fábrica, inspirado en todo lo que había aprendido y convencido de que seguía siendo una industria con futuro, motivó a sus empleados a unirse y hacerse cargo de manera cooperativa de la misma. Hoy fruto de ello y en manos de Roberto Quintana, hijo de su primer empleado, continúa fabricando y produciendo para un gran mercado.
`,
      assets: [
...
Desde la aparición de las Salas Velatorias y las primeras Cooperativas, y ya de la mano de uno de los hijos de Don Nélido, la empresa fue creciendo y expandiendo sus fronteras. Así hoy conducida por la tercera generación logra brindar un servicio integral (fabricación de insumos funerarios, hospitalarios, morgues y cementerios) y permanente a todas las empresas ligadas al rubro.`,
   ...
   },
   {
      ...
      date: "1974",
      logo: "./assets/DiaIndustria/Gomez/logo.jpeg",
      content: `Luego de trabajar en la industria del automotor desde los 12 años en Villa María y en Mar del Plata, General Deheza lo recibe a Osvaldo, el Negro Gómez como todos hoy lo conocen. Acompañado por Mary, quienes hacían eco a la invitación de su suegro, quien veía en la localidad una clara oportunidad laboral. Llega con apenas unas pequeñas valijas y un calibre, dispuestos a arrancar en la industria de la electromecánica del automotor. Comenzaron en su hogar, ubicado en la esquina Froute y Belgrano. Se las ingeniaban para dividir a partir de un biombo el hogar del taller, y usaban el cordón de las veredas para poder elevar los autos y poder trabajar en ellos.
