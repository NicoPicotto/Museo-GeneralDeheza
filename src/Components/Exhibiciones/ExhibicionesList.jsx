const exhibiciones = [
	{
		...
		shortDescription: `Alumnos de Tercero, Cuarto, Quinto y Sexto año de la especialidad Arte del Instituto Técnico Adrián P. Urquía expusieron desde el día 28/09/23 hasta el 09/10/23. La muestra fusionó una variedad de técnicas, materiales y formatos. Entre ellas pudimos apreciar pinturas con técnica mixta en gran formato, dibujos, fotografías y pinturas al óleo. Además, en la apertura de la muestra, el Taller de Música del COE nos acompañó con una presentación en vivo.`,
		vigente: true,
		portada: 'assets/Exhibiciones/01/15.jpg',
		slug: 'itapu',
	},
	{
